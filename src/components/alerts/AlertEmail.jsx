...
export default function AlertEmail({ children }) {
  ...
  return (
    <>
      <div className={`${show ? `flex items-center opacity-[0.9]` : `hidden`}`}>
        <div className="absolute d:top-[172vh] bg-blue-200 py-8 px-8 m:mb-[5.5rem] d:h-[16rem] d:w-[38rem] dv:w-[46rem]">
          <button
            className="absolute font-bold text-[25px] right-[20px] top-0"
          ...
          <div className="flex justify-between mt-5 gap-2">
            ...
            />
            <span className="flex items-center justify-center bg-orange-300 text-white m:w-[170px] d:w-[150px] h-[40px] rounded-[5px] m:px-[7px]">
              Count me in!
            </span>
          </div>
        </div>
